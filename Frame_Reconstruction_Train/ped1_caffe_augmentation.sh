...
singularity exec --nv -B $TMPDIR:/tmp -B /nobackup/schtmt /nobackup/schtmt/containers/caffe_lstm_wta_gpu.img /opt/caffe/build/tools/caffe train --solver=/nobackup/schtmt/home_temp/ucsd_conv_lstm_frame_AE_6/solver_ped1_augmentation.prototxt 2>&1|tee /nobackup/schtmt/home_temp/ucsd_conv_lstm_frame_AE_6/ped1_AE6_aug.log
