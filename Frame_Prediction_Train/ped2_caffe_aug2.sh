...
singularity exec --nv -B $TMPDIR:/tmp -B /nobackup/schtmt /nobackup/schtmt/containers/caffe_lstm_wta_gpu.img /opt/caffe/build/tools/caffe train --solver=/nobackup/schtmt/home_temp/ucsd_conv_lstm_frame_prediction_6/solver_ped2_aug2.prototxt 2>&1|tee /nobackup/schtmt/home_temp/ucsd_conv_lstm_frame_prediction_6/ped2_pred6_aug_2.log
