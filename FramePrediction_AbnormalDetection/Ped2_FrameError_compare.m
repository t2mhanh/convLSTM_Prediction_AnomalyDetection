...
clear all
% aug1
aug1_decision_map_path = '/usr/not-backed-up/1_convlstm/prediction_aug1_ped2/';
% aug2
aug2_decision_map_path = '/usr/not-backed-up/1_convlstm/prediction_aug2_ped2/';
% recons-aug1
recons_aug1 = '/usr/not-backed-up/1_convlstm/Ped2_AE6/';
addpath('../')
%gt
...
for numTestFolders = [ 2, 4, 5, 7]%1:12
    numTestFolders
    % aug1 
...
%     legend('aug1')
    ...
    print(['ped2_FrameError_CompareAug1Aug2_seq' num2str(numTestFolders)],'-djpeg')
