close all
clear all
decision_map_path = '/usr/not-backed-up/1_convlstm/prediction_aug1_ped2/';
ImDir = fullfile('/usr/not-backed-up/1_DATABASE/UCSD_Anomaly_Dataset.tar/UCSD_Anomaly_Dataset.v1p2/VideoSequences/UCSDped2/Test'); 
addpath('../')
%gt
...
v = VideoWriter(sprintf('ped2_6seqs%0.2f.avi',ab_thres));
v.FrameRate = 24;
v.Quality = 100;
open(v)

for numTestFolders = 1:12%[1 2 4 5 7 8]
    numTestFolders    
