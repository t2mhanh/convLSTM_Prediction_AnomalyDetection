...
ab_thres = 0.9;
v = VideoWriter(sprintf('entrance_seq5_thres%0.2f.avi',ab_thres));
v.FrameRate = 24;
v.Quality = 100;
open(v)
for numTestFolders = 5%1:6%[1 2 3 4 10 12 18]%    
    ...
    load(fullfile('/usr/not-backed-up/1_DATABASE/Adam dataset/Entrance/TestSeq',['Test' num2str(numTestFolders) '.mat']))
